...
class Game:
    ...
    def __init__(self, nombre_jouers = 2, puissance = 4, nombre_colonnes = 4, nombre_lines = 4, customize = False):
        """ Construit la partie sur base du nbre de joueur, la puissance, le nbre de colonnes, nbre de lignes
           PRE : nbre de joueur, la puissance, le nbre de colonnes, nbre de lignes doivent etre des chiffres
           POST : instancie les valeurs de nbre de joueur,  puissance, nbre de colonnes, nbre de lignes
        """
